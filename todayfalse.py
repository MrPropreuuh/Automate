...
def reset_today_to_false():
    ...
    # Mise à jour du champ 'today' pour chaque compte
    ...
    if comptes_modifies:
        try:
            ...
            print("Tous les champs 'today' ont été mis à 'false'.")
        except IOError:
            print("Erreur lors de l'écriture dans le fichier.")
    else:
        print("Aucun champ 'today' n'a été modifié.")


# Exécuter la fonction pour mettre à jour le fichier JSON
reset_today_to_false()
